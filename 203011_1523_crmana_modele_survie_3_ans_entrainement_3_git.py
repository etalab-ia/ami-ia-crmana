...
def get_data_metier_milieu(metier, milieu, relevant_fields):
    ...
    query = """
        select a.siret, b.duree_vie, b.survie_3_ans, c.type_com as type_milieu_2, c.statut_2017 as type_milieu_4
...
def find_best_models(data, scorer, cv):
    ...
    X_transformed, liste_chiffres = filter_most_signifiant_features(best_rf_model_3, X_3, y_3)
    ...
    # }
    return {
        '3': {'dataset_name': '3', 'X': X_transformed, 'y': y_3, 'optimized_models': [{'model_name': 'rf', 'optimized_model': best_rf_model_3}], 'liste_chiffres': liste_chiffres}
    }
